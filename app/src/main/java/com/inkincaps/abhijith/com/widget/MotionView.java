package com.inkincaps.abhijith.com.widget;
...
import com.inkincaps.abhijith.com.multitouch.MoveGestureDetector;
import com.inkincaps.abhijith.com.multitouch.RotateGestureDetector;
...
public class MotionView  extends FrameLayout {
    ...
    public void addImage(@Nullable MotionEntity entity){
        if(entity!=null){
            entities.add(entity);
            selectEntity(entity,false);
        }
